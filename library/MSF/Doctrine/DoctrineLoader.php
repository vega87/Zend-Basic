 ...
 */
class MSF_Doctrine_DoctrineLoader extends MSF_Singleton{
    ...
    protected static function _initClassLoader() {
         ...
         *
         */
        $MSFLoader = MSF_System_ClassManager::getInstance('MSF_System_Autoloader');
        $MSFAutoloader = array($MSFLoader, 'loadClass');
         ...
         *
         */
        $autoloader = MSF_System_ClassManager::getStaticInstance('Zend_Loader_Autoloader', 'getInstance');
        $autoloader->pushAutoloader($doctrineAutoloader, 'Doctrine\\');
        $autoloader->pushAutoloader($symfonyAutoloader, 'Symfony\\');
        $autoloader->pushAutoloader($MSFAutoloader, array('Schema','Entity', 'Repository'));
    ...
    protected static function _initDoctrine2() {
        ...
        if (file_exists($configPath)) {
            ...
            MSF_System_ClassManager::getStaticInstance('MSF_Config', 'createInstance', $supplementalConfig);
        }
        $connectionSettings = MSF_System_ClassManager::getStaticInstance('MSF_Config', 'getInstance')->getValue('doctrine.connectionParameters');
        ...
        $entityManager->getConnection()->getConfiguration()->setSQLLogger( new MSF_Doctrine_Logging_FileSQLLogger());
