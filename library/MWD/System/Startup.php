 ...
 */
class MWD_System_Startup extends MWD_Singleton
{
    ...
    public static function init() {
        ...
        require_once(MWD_PATH.DS.'Config.php');
    ...
    public static function run() {
        MWD_System_ClassManager::getStaticInstance('MWD', 'getInstance')->getApplication()->bootstrap()->run();
    }
    ...
    protected static function initConfiguration() {
        MWD_System_ClassManager::getStaticInstance('MWD_Config', 'createInstance', self::$_systemConfig);
        MWD_System_ClassManager::getInstance('MWD', 'getInstance')->getApplication()->setOptions(self::$_systemConfig->{APPLICATION_ENV}->toArray());
    }
    ...
    protected static function initZendFramework() {
        ...
        $application = MWD_System_ClassManager::getInstance('Zend_Application',
            APPLICATION_ENV
        );

        MWD_System_ClassManager::getStaticInstance('MWD', 'getInstance')->setApplication($application);
    }
